...
const CompleteRegistrationCreativoEstilista06 = () => {
    ...
    const handleNext = async () => {
        ...
        // Verifica si la fecha está fuera del rango permitido
                ...
                <div className="form-group-datos">
                    ...
                    <div className="input-with-icon" style={{ position: 'relative' }}>
                        <input
                            ...
                            className="input-field"
                            style={{ backgroundColor: '#f0f0f0', color: '#000' }}
                            min={minMonth}  // Evita seleccionar fechas menores a 90 años atrás
                            max={currentMonth}  // Evita seleccionar fechas futuras
                        />
                        <span
